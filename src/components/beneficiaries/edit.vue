<template>
	<div class="absolute top-0 left-0 bottom-0 right-0 bg-overlay flex justify-end" v-if="editBeneficiaryStatus">
			<div class="p-6 overflow-auto h-full bg-white w-[50%] max-w-[500px] flex flex-col gap-[40px]">
				<div class="flex flex-col gap-2">
					<h4 class="heading5 md:heading4 text-boldText">Edit Beneficiary</h4>
					<p class="small-text text-[#404040]">Please add a beneficiary. This would be the details of your ward for which you would like us to make the fees payment</p>
				</div>
				<form class="flex flex-col gap-5">
					...
					<SelectComp :isSchool="true" v-model="schoolName" :toSelect="schools" label="Name of school" selectType="school"/>
				...
				<div class="flex gap-4 items-center justify-between">
					<p class="normal-text text-primary w-full max-w-fit font-medium cursor-pointer" @click="closeEditBeneficiaries">Cancel</p>
...
const gender = ref('')
const { editBeneficiaryStatus, closeEditBeneficiaries } = useBeneficiaries()
